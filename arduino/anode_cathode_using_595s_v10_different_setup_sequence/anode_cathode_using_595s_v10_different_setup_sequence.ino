...
\ \____\\ \_\ \_\ \__/.\_\ \_\ \_\ \____ \ \____\/\____\ \____/\ \____ \
 \/____/ \/_/\/_/\/__/\/_/\/_/\/_/\/___L\ \/____/\/____/\/___/  \/___L\ \
                                    ...
                                    \_/__/                        \_/__/
-- v10
  - added some lines of code at beginning of setup() because of the info at this page: 
    http://playground.arduino.cc/Hardware/Yun#rebootStability
    - when rebooting linux, the arduino side was receiving all sorts of serial data, to the
      point of making it hang. So now we simply a) wait a bit and b) wait for the initial 
      serial chatter to die down before executing the rest of the Arduino sketch
  ...
  */
  ...
  for (byte col = 0; col < 62; col++) {
    for (byte rowByte = 0; rowByte < 5; rowByte++) {
      ...
      // override
      row_data[col][rowByte] = B11001100;
    }
  }
